...
<body>
    ...
    if (isset($_POST['save']))
    {
      ...
      $query=mysqli_query($con,"insert into student_result(f_name,course,scheme,enrollment_no,email,phone_no,maths,science,total,percentage,remark)values('$f_name','$course','$scheme','$enrollment_no','$email','$phone_no','$maths','$science','$a','$b','$c')") or die(mysqli_error($con));
      if($query)
    ...
    <div class="col-sm-8">
      <div class="panel panel-default panel-primary">
        <div class="panel-heading" >
          <h2 class="panel-title" >Student Registration form</h2>
        </div>
        <div class="panel-body">
          ...
          <form id="formstr" name="asformid1" action="" method="POST">
            ...
            <div class="form-group ">
              ...
              <input type="text" class="form-control validate[required] to" id="strfid6" placeholder="Phone No" name="phone_no" maxlength="10" >
            </div>
