    ...
    <div class="col-md-6" id="alfgsid1">
      <div class="panel panel-default panel-primary">
        ...
        <div class="panel-body">
          <form id="form1" action="login_admin_page.php" method="POST" >
          
              <div class="form-group">
                <label for="user">Admin User-Id: </label><br>
                <input type="text" class="form-control validate[required,custom[email]] text-input" id="user"
                  name="user" placeholder="Admin User." maxlength="50">
              </div>

              <div class="form-group ">
                <label for="falid2">Password: </label><br>
                <input type="password" name ="pass" class="form-control validate[required] text-input" id="falid2" placeholder="Password."><br>
              ...
              <input type="submit" class="form-control btn-success" id="strfid7" value="Login">
            </form>
        </div>
      </div>
    </div>
